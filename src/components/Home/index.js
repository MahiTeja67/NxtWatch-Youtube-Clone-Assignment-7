...
export default class Home extends Component {
  ...
  renderBannerView = () => {
    ...
    return (
      <BannerContainer dispBanner={bannerDisplay} data-testid="banner">
        <CloseButton data-testid="close" onClick={this.closeBan}>
          <GrClose />
        </CloseButton>
        <BannerLogo
          ...
          return (
            <AppHomeContainer bgColor={appBgColor}>
              ...
              <HomeContainer data-testid="home" bgColor={backgroundColor}>
                ...
                <RightSection>
                  {bannerDisplay === 'flex' ? this.renderBannerView() : null}
                  <VideosContainer>
                    <SearchContainer>
                      <Search
                        type="search"
