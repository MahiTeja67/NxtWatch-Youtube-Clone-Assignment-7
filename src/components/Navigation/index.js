            ...
            <NavItemsContainer>
              <NavLink to="/">
                <NavItem
                  ...
                  shado={activeTab === 'Home' ? activeTabSh : 'none'}
                >
                  <AiFillHome
                    size={20}
              ...
              <NavLink to="/trending">
                <NavItem
                  ...
                  shado={activeTab === 'Trending' ? activeTabSh : 'none'}
                >
                  <HiFire
                    size={20}
              ...
              <NavLink to="/gaming">
                <NavItem
                  ...
                  shado={activeTab === 'Gaming' ? activeTabSh : 'none'}
                >
                  <SiYoutubegaming
                    size={20}
              ...
              <NavLink to="/saved-videos">
                <NavItem
                  ...
                  shado={activeTab === 'Saved' ? activeTabSh : 'none'}
                >
                  <BiListPlus
                    size={20}
